...
public:
	...
	virtual void OnPrvtMessage(const std::string & Sender, const std::string & Message, std::string & Response) = 0;
	virtual void OnNotice(const std::string & Sender, const std::string & Message, std::string & Response) = 0;
	virtual void OnUserMode(const char Mode, const bool Set, std::string & Response) = 0;
...
public:
	...
	virtual void OnChannelMode(const char Mode, const bool Set, std::string & Response) = 0;

	virtual void OnJoin(const std::string & Nick, const std::string & User, const std::string & Host, std::string & Response) = 0;
	virtual void OnPart(const std::string & Nick, const std::string & User, const std::string & Host, std::string & Response) = 0;
	virtual void OnQuit(const std::string & Nick, const std::string & User, const std::string & Host, std::string & Response) = 0;
	virtual void OnKick(const std::string & Nick, const std::string & User, const std::string & Host, const std::string & Victim, std::string & Response) = 0;
